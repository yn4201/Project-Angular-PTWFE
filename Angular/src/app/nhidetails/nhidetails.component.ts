...
@Component({
  selector: 'app-nhidetails',
  templateUrl: './nhidetails.component.html',
  styleUrls: ['./nhidetails.component.css']
})
export class NhidetailsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<NhidetailsComponent>,
